...
class HomeDetailTopCell: UICollectionViewCell {
    static let key = "HomeDetailTopCell"
    ...
    override init(frame: CGRect) {
        ...
        component.snp.makeConstraints { $0.edges.height.equalToSuperview() }
    }
